...
const veterinaria1 = new Veterinaria("Veterinaria A", "Calle 123"); 
...
veterinaria1.agregarCliente(new Cliente("Juan", 15550055, 12345678));
veterinaria1.agregarCliente(new Cliente("María", 12312323, 98765421));
veterinaria1.agregarCliente(new Cliente("Pedro", 12312322, 55512456)); 
veterinaria1.agregarCliente(new Cliente("Luisa", 12312324, 44497654)); 
veterinaria1.agregarCliente(new Cliente("Pascual", 15434343, 22333123));
...
veterinaria1.agregarPaciente(new Paciente("1", "Fido", "Perro"));
veterinaria1.agregarPaciente(new Paciente("2", "Miau", "Gato"));

console.log("Pacientes después de agregar:", veterinaria1);

// 6. Agregar Proveedores
console.log("Agregando proveedores...");
redVeterinarias.agregarProveedor(new Proveedor("Proveedor A", "contacto@proveedora.com"));
redVeterinarias.agregarProveedor(new Proveedor("Proveedor B", "contacto@proveedorb.com"));
